class Courses:
    def __init__(self, courseId, dept, courseNum, termsOffered, units, courseName,
                 raw_concurrent_text, raw_recommended_text, raw_prerequisites_text, crossListedAs,
                 raw_standing_text, standing):
